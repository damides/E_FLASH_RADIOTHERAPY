...
// 
//////////////////////////////////////////////////////////////////////////////////////////////
#ifndef FLASHGeometryMessenger_h
#define FLASHGeometryMessenger_h 1

#include "globals.hh"
#include "G4UImessenger.hh"
#include "G4String.hh"

class FLASHGeometryController;
class G4UIdirectory;
class G4UIcmdWithADoubleAndUnit;
class G4UIcmdWithAString;
class G4UIcmdWithoutParameter;

class FLASHGeometryMessenger: public G4UImessenger
{
public:
  FLASHGeometryMessenger(FLASHGeometryController* );
  ~FLASHGeometryMessenger();
