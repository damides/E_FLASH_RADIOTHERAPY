...
/////////////////////////////////////////////////////////////////////////////
FLASHEventActionMessenger::FLASHEventActionMessenger(FLASHEventAction* EvAct)
:eventAction(EvAct)
{
...
/////////////////////////////////////////////////////////////////////////////
FLASHEventActionMessenger::~FLASHEventActionMessenger()
{
  delete DrawCmd;
  delete PrintCmd;
  delete eventDir;         
...
/////////////////////////////////////////////////////////////////////////////
void FLASHEventActionMessenger::SetNewValue(G4UIcommand* command,
                                          G4String newValue)
{ 
  if(command == DrawCmd)
